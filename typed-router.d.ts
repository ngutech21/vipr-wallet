...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/settings/': RouteRecordInfo<
      ...
      never
    >
    '/settings/backup': RouteRecordInfo<
      '/settings/backup',
      '/settings/backup',
      Record<never, never>,
      Record<never, never>,
      never
    >
    '/settings/backup-words': RouteRecordInfo<
      ...
      never
    >
    '/startup-wizard': RouteRecordInfo<
      '/startup-wizard',
      '/startup-wizard',
      Record<never, never>,
      Record<never, never>,
      never
    >
    '/transaction/[id]': RouteRecordInfo<
      '/transaction/[id]',
      '/transaction/:id',
      { id: ParamValue<true> },
      { id: ParamValue<false> },
